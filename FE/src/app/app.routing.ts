...
export const routes: Routes = [
    { 
        ...
        component: PagesComponent, children: [
            ...
            { path: 'account', canActivate: [AuthGuard], loadChildren: () => import('./pages/account/account.module').then(m => m.AccountModule) }, 
            { path: 'submit-property', canActivate: [AuthGuard], loadChildren: () => import('./pages/submit-property/submit-property.module').then(m => m.SubmitPropertyModule) }   
        ]
    },
